...
VALUES
    (
        ...
        'Mufasa - Il re leone',
        'Mufasa - Il re leone',
        'Mufasa: <span lang="en">The Lion King</span>',
        'Inglese',
        '2024-12-18',
        '118',
        'Rilasciato',
        '200000000',
        '539677479',
        '<span lang="en">Rafiki</span> narra la leggenda di <span lang="en">Mufasa</span> alla giovane leoncina <span lang="en">Kiara</span>, figlia di <span lang="en">Simba</span> e <span lang="en">Nala</span>, con <span lang="en">Timon</span> e <span lang="en">Pumbaa</span> che offrono il loro caratteristico spettacolo. Raccontata attraverso <span lang="en">flashback</span>, la storia presenta <span lang="en">Mufasa</span>, un cucciolo orfano, perso e solo fino a quando incontra un leone compassionevole di nome <span lang="en">Taka</span>, erede di una stirpe reale. L''incontro casuale dà il via al viaggio di uno straordinario gruppo di sventurati alla ricerca del proprio destino: i loro legami saranno messi alla prova mentre lavorano insieme per sfuggire a un nemico minaccioso e letale.',
        'images/film/eZS2taWdadP8lh22xJOVrWT0lTn.webp'
    ),
    (
        '2',
        'Sonic 3 - Il film',
        '<span lang="en">Sonic</span> 3 - Il film',
        '<span lang="en">Sonic the Hedgehog</span> 3',
        'Inglese',
        '2024-12-19',
        '110',
        'Rilasciato',
        '122000000',
        '384815196',
        '<span lang="en">Sonic</span>, <span lang="en">Knuckles</span> e <span lang="en">Tails</span> si ritrovano a dover fronteggiare un nuovo e formidabile nemico:  <span lang="en">Shadow</span>, un misterioso <span lang="en">villain</span> con poteri incredibili mai visti prima. Con le loro abilità messe alla prova in ogni modo, il <span lang="en">Team Sonic</span> dovrà cercare un''alleanza inaspettata per fermare <span lang="en">Shadow</span> e proteggere il pianeta.',
    ...
    (
        ...
        'Il gladiatore II',
        'Il gladiatore II',
        '<span lang="en">Gladiator</span> II',
        'Inglese',
        '2024-11-05',
        '148',
        'Rilasciato',
    ...
    (
        ...
        '150000000',
        '989755208',
        'A tre anni dal suo primo viaggio, <span lang="haw">Vaiana</span> è impegnata in un lungo viaggio alla ricerca di persone oltre le coste di <span lang="haw">Motunui</span>. Assieme a <span lang="haw">Maui</span> e a un nuovissimo equipaggio di improbabili marittimi, <span lang="haw">Vaiana</span> si imbarca alla volta dei lontani mari dell''<span lang="haw">Oceania</span> in acque pericolose per un''avventura diversa da qualsiasi cosa abbia mai affrontato.',
        'images/film/dPnRomNzww9G7dgS84f6HSevVLc.webp'
    ),
    (
        '5',
        'Wicked',
        '<span lang="en">Wicked</span>',
        '<span lang="en">Wicked</span>',
        'Inglese',
        '2024-11-20',
        '162',
    ...
    (
        ...
        'Il Signore degli Anelli - La guerra dei Rohirrim',
        '<span lang="en">The Lord of the Rings: The War of the Rohirrim</span>',
        'Inglese',
        '2024-12-05',
        '134',
        'Rilasciato',
    ...
    (
        ...
        '250000000',
        '185700759',
        'Dopo che Babbo Natale - nome in codice: UNO ROSSO - viene rapito, il capo della sicurezza del Polo Nord (<span lang="en">Dwayne Johnson</span>) deve fare squadra con il più famigerato cacciatore di taglie del mondo (<span lang="en">Chris Evans</span>) in una missione travolgente e ricca di azione per salvare il Natale.',
        'images/film/xjmVhig5Y856SCDFwvUMLaqi8hH.webp'
    ),
    (
        '10',
        'Elevation',
        '<span lang="en">Elevation</span>',
        '<span lang="en">Elevation</span>',
        'Inglese',
        '2024-11-07',
        '91',
        ...
        '18000000',
        '3300000',
        'Un padre <span lang="en">single</span> e due donne escono dalla sicurezza delle loro case per affrontare creature mostruose e salvare la vita di un ragazzino.',
...
VALUES
    ...
    ('10', '108', 'Tim'),
    ('10', '109', 'Nina’s Son'),
    ('10', '110', 'Nina’s Husband'),
    ('10', '111', 'Refugee');

UPDATE movie_cast
SET
    role = CONCAT ('<span lang="en">', role, '</span>');
