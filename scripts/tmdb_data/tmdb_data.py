...
def fetch_movies():
    ...
    for movie in tqdm(movies_data, desc="Processing Movies", unit="movie"):
        ...
        movie.update({
            ...
            "description": movie_info["overview"] if movie_info["overview"] else "Informazione non disponibile",
            "image_path": movie_info["poster_path"][1:] if movie_info["poster_path"] else None
        })
