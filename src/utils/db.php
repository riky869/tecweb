...
class DB
{
    ...
    {
        $host = getenv("DB_HOST") ?? DEFAULT_VARS["DB_HOST"];
        $user = getenv("DB_USER") ?? DEFAULT_VARS["DB_USER"];
        $pass = getenv("DB_PASS") ?? DEFAULT_VARS["DB_PASS"];
        $dbname = getenv("DB_NAME") ?? DEFAULT_VARS["DB_NAME"];
